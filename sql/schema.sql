...
CREATE TABLE reservations (
	...
	is_promotional bool DEFAULT false NOT NULL,
	...
	CONSTRAINT reservations_check CHECK (((cancellation_time IS NULL) OR (cancellation_time > reservation_time))),
	CONSTRAINT reservations_pkey PRIMARY KEY (id),
	CONSTRAINT reservations_price_paid_check CHECK ((price_paid >= (0)::numeric)),
